...
const UserBasicInfoSearch = ({ userid }) => {
    ...
    const submit = async () => {
        ...
        settel(rew.data.telephone)
        if (rew.data.transactiondetails) {
            settransactiondetails(JSON.parse(rew.data.transactiondetails) || [])
        } else {
...
export default UserBasicInfoSearch;
