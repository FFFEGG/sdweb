            ...
            <Box height={'60vh'} overflow={'scroll'} mt={3}>
                <AgGridReact
                    ...
                    onCellDoubleClicked={async (e)=>{
                        ...
                        // project	字符串	必须			项目
                        const rew = await request('post','/api/getInfo',{
                            url: 'Srapp.Web_Report_Manage_Infos.KfzxServiceOrderDetailsOfDetails',
...
export default KfzxServiceOrderDetails;
