...
const GPGLBBuyMaterialStatistics = () => {
     ...
     return (
          <Box p={3} bgcolor={'white'} borderRadius={1}>
               <Box fontSize={18} mb={3}>钢瓶管理部 收购瓶数据统计</Box>
               <Form getFormApi={e => api.current = e} layout="horizontal" labelPosition="inset" onSubmit={async e => {
                    const rew = await request('post', '/api/getInfo', {
                         url: 'Srapp.Web_Report_Material_Infos.GPGLBBuyMaterialStatistics',
                         ...e,
               ...
               <Box mt={3} height={'60vh'}>
                    <AgGridReact
                         ...
                         columnDefs={[
                              // {
                              //      "addtime": "2023-05-18 10:02:11.553",
                              //      "serial": "800020230518100211505186579",
                              ...
                              //      "difference": 5
                              //  }
                              { field: 'addtime', headerName: '收购时间', sortable: true,  },
                              { field: 'serial', headerName: '钢瓶编号', sortable: true,  hide: true },
                              { field: 'packingtype', headerName: '钢瓶类型', sortable: true,  },
                              { field: 'gs', headerName: '是否公司瓶', sortable: true,  },
                              { field: 'reg_number', headerName: '钢印号', sortable: true,  },
                              { field: 'manufactureyear', headerName: '出厂年份', sortable: true,  },
                              { field: 'bf', headerName: '是否报废', sortable: true,  },
                              { field: 'marketprice', headerName: '市场价', sortable: true,  },
                              { field: 'price', headerName: '收购价', sortable: true,  },
                              { field: 'department', headerName: '业务部门', sortable: true,  },
                              { field: 'operator', headerName: '员工', sortable: true,  },
                              { field: 'quarters', headerName: '岗位', sortable: true,  },
                              { field: 'difference', headerName: '差价', sortable: true,  },
                         ]}
                         rowData={list}
...
export default GPGLBBuyMaterialStatistics;