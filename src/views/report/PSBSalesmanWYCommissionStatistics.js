...
const PSBSalesmanWYCommissionStatistics = () => {
     ...
     return (
          <Box p={3} bgcolor={'white'} borderRadius={1}>
               <Box fontSize={18} mb={3}>配送部 业务员往月开户提成</Box>
               <Form getFormApi={e => api.current = e} layout="horizontal" labelPosition="inset" onSubmit={async e => {
                    const rew = await request('post', '/api/getInfo', {
                         url: 'Srapp.Web_Report_Business_Infos.PSBSalesmanWYCommissionStatistics',
                         ...e,
                    ...
                    rew.data.info.push({
                         ...
                         commission: rew.data.info.reduce((a, b) => a + parseFloat(b.commission), 0).toFixed(2),
...
export default PSBSalesmanWYCommissionStatistics;