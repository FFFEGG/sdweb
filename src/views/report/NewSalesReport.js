...
const NewSalesReport = () => {
     ...
     useEffect(() => {
          ...
          */
          ...
          if (loginuser.login_department.includes("商用")) {
               seformatype('商用气报表')
          ...
          <Box p={3} bgcolor="#fff">
               ...
               <Form getFormApi={e => api.current = e} onSubmit={async e => {
                    const rew = await request('post', '/api/getInfo', {
                         url: 'Srapp.Web_Report_Finance_Infos.NewSalesReport',
                         ...e,
                         formatype,
                         ...
                         <Box mt={3}>
                              ...
                              <table className="my-table">
                                   ...
                                   <tr>
                                        ...
                                        <td>{gethj(montharrears, 'pay_arrears', 2)}</td>
                                   </tr>
                              ...
                              <table className="my-table">
                                   ...
                                   <tr>
                                        ...
                                        <td>{gethj(casharrears, 'pay_cash', 2)}</td>
                                   </tr>
...

                              {
                                   attributiondepartmentlist_arr.map(item =>
                                        ...
                                        <div>
                                             ...
                                             <table className="my-table">
                                                  <tr>
                                                       <th colSpan="6">{item.attributiondepartment}送气欠款明细(月结)</th>
                                                  </tr>
                                                  <tr>
                                                       <td>归属部门</td>
                                                       <td>单位</td>
                                                  ...
                                                  {
                                                       getdepartmentarrears(montharrears, item.attributiondepartment).map(item =>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td></td>
                                                       <td></td>
                                                       <td>{gethj(getdepartmentarrears(montharrears, item.attributiondepartment), 'num', 0)}</td>
                                                       <td>{gethj(getdepartmentarrears(montharrears, item.attributiondepartment), 'pay_arrears', 2)}</td>
                                                  </tr>
                                             ...
                                             <table className="my-table">
                                                  <tr>
                                                       <th colSpan="6">{item.attributiondepartment}送气欠款明细(现结)</th>
                                                  </tr>
                                                  <tr>
                                                       <td>归属部门</td>
                                                       <td>单位</td>
                                                  ...
                                                  {
                                                       getdepartmentarrears(casharrears, item.attributiondepartment).map(item =>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td></td>
                                                       <td></td>
                                                       <td>{gethj(getdepartmentarrears(casharrears, item.attributiondepartment), 'num', 0)}</td>
                                                       <td>{gethj(getdepartmentarrears(casharrears, item.attributiondepartment), 'pay_cash', 2)}</td>
                                                  </tr>
