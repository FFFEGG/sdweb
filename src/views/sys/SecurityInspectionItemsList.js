...
const SecurityInspectionItemsList = () => {
        ...
        <Box p={3} borderRadius={1} bgcolor={'#fff'}>
            <Box display={"flex"}>
                <Button onClick={async e => {
                    const rew = await request('post', '/api/getInfo', {
                        url: 'Srapp.Web_SystemInfo.SecurityInspectionItemsList'
                    })
            ...
            <Box height={'60vh'} mt={3} overflow={"scroll"}>
                ...
                <AgGridReact
                    ...
                    columnDefs={[
                        ...
                        { field: 'version', headerName: '解析版本' },
                        { field: 'detailed', headerName: '安检项目' },
            ...
            <Modal visible={open} onCancel={() => setopen(false)} footer={<></>} style={{ top: 100 }}>
                <Form onSubmit={async e => {
                    // console.log(e)
                    const rew = await request('post', '/api/getInfo', {
                        url: 'Srapp.Web_SystemSetting.SettingSecurityInspectionItems',
                        ...e
                    })
                    ...
                    <Form.Input field={'name'} label={'安检项目名称'} />
                    <Form.Input field={'version'} label={'解析版本'} />
                    <Form.Input field={'detailed'} label={'安检项目'} />
...
export default SecurityInspectionItemsList;
